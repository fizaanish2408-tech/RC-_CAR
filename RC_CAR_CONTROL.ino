  ...
  String html =
    ...
    "<head>"
      ...
      "<style>"
        ...
        // Buttons overlay at bottom left
        ".controls{"
          "position:fixed;"
          "bottom:80px;"
          "right:20px;"
    ...
    "<body>"
      ...
      "<img class='video-box' src='http://192.168.46.131:8080/video'>"  // use img not iframe

      "<div class='heading'>RC CAR CONTROLLER</div>"

      "<div class='controls'>"
        "<div>"
          "<button class='btn' onmousedown='send(\"F\")' onmouseup='send(\"S\")'>▲</button>"
        "</div>"
        "<div>"
        ...
        "</div>"
        "<div>"
          "<button class='btn' onmousedown='send(\"B\")' onmouseup='send(\"S\")'>▼</button>"
        "</div>"
      "</div>"
